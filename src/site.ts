/* ----------------------------------------------------------------
   Shared site behaviour — nav, scroll reveals, hero tilt, the reserve
   form state machine, scroll progress + parallax, and CTA magnetism.

   Lifted out of main.ts so the Beta page runs the exact same choreography.
   Everything is DOM-guarded and generic: calling initSite() on a page that
...
export function initSite(): void {
  ...
  /* Hero bike: subtle pointer-driven tilt for depth. Settles to rest and
     stops the loop when idle or off-screen. */
  ...
  /* Reserve form — full state machine: idle → invalid → submitting → success */
